...
namespace Project_2
{
    public partial class Form1 : Form
    {
        ...
        private void A2_Click(object sender, EventArgs e)
        {
            ...
            byte[] byteArr = Encoding.ASCII.GetBytes(textToSend);
        }

        private void receiveHit(byte[] message)
        {
            string buffer = Encoding.ASCII.GetString(message);
            string result;
            ...
            byte[] byteArr = Encoding.ASCII.GetBytes(result);
        }
    }
}
